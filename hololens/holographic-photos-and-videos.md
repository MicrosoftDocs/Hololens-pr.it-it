...
- Da Esplora file nel PC è possibile selezionare le proprietà del dispositivo per visualizzare il numero di versione del sistema operativo Windows olografico (versione del firmware), il numero di serie del dispositivo e la percentuale di batteria.
