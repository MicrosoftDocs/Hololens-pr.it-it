...
description: Si ha una domanda rapida su come HoloLens o sull'interazione con gli ologrammi?  Questo articolo offre una risposta rapida e altre risorse.
...
Per suggerimenti su come mettere in HoloLens, vedere [Adattare](hololens2-setup.md#adjust-fit).
...
- Assicurarsi che nell'ambiente sia presente una luce sufficiente in modo che HoloLens possibile visualizzare e mappare lo spazio.
...
- Aggirare le stanze in modo HoloLens possibile eseguire nuovamente l'analisi dell'ambiente circostante. Per visualizzare ciò che è già stato analizzato, toccare l'aria per visualizzare l'immagine della mesh di mapping.
...
Se ci si avvicina troppo a un ologramma, il ripristino dell'ologramma verrà temporaneamente &mdash; rimosso. Inoltre, se sono stati posizionati più ologrammi vicini, alcuni potrebbero scomparire. Provare a rimuovere alcuni elementi.
