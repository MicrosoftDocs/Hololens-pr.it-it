...
HoloLens 2 usa la tecnologia di tracciamento oculare per migliorare l'esperienza di visualizzazione e interazione con l'ambiente virtuale. La calibrazione HoloLens 2 garantisce che sia in grado di tenere traccia accuratamente degli occhi (e degli occhi di chiunque usi il dispositivo). Aiuta anche con il comfort dell'utente, l'allineamento degli ologrammi e il tracciamento delle mani. Dopo la calibrazione, gli ologrammi verranno visualizzati correttamente anche quando la visiera si sposta sulla testa.
...
1. Selezionare **Impostazioni** e quindi selezionare Calibrazione oculare  >    >  **calibrazione** sistema  >  **Eseguire calibrazione oculare**.
...
> [!NOTE]
> Il Impostazioni è stato rimosso a Windows Holographic, versione 20H2 con l'avvio di [Auto Eye Position Support](hololens-release-notes.md#auto-eye-position-support). La richiesta di calibrazione verrà visualizzata automaticamente solo se un utente non bilanciato usa un'app abilitata per Eye Tracking.
