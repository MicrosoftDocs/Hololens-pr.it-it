...
| --- | --- | --- |
| [Azure Active Directory](/azure/active-directory/)<sup>1</sup>  | 64 | <ul><li>Provider di credenziali Web di Azure</li><li>App Authenticator Azure</li><li>Biometria (Iris) &ndash; HoloLens 2 solo<sup>2</sup> </li><li>PIN &ndash; Facoltativo per HoloLens (prima generazione), necessario per HoloLens 2</li><li>Password</li></ul> |
...
Il modo più comune per configurare un nuovo utente è HoloLens'esperienza di configurazione. Durante l'HoloLens richiede a un utente di accedere usando l'account che vuole usare nel dispositivo. Questo account può essere un account Microsoft consumer o un account aziendale configurato in Azure. Vedere Configurazione del HoloLens [(prima generazione)](hololens1-start.md) [o HoloLens 2](hololens2-start.md).
...
HoloLens 2 supporta l'autenticazione Iris. Iris si basa sulla tecnologia Windows Hello ed è supportato per l'uso da parte degli account Azure Active Directory e Microsoft. Iris viene implementato come altre tecnologie Windows Hello e ottiene la sicurezza biometrica fino a 1/100.000.
