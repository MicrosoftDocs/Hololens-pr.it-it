...
| --- | --- | --- |
| [Azure Active Directory](https://docs.microsoft.com/azure/active-directory/) (richiede Azure AD Premium) | 64 | <ul><li>Provider di credenziali Web di Azure</li><li>Azure Authenticator App</li><li>Dati biometrici (Iris) &ndash; HoloLens 2 solo<sup>1</sup> </li><li>PIN &ndash; facoltativo per HoloLens (prima generazione), obbligatorio per HoloLens 2</li><li>Password</li></ul> |
...
> [!NOTE]
> **HoloLens (prima generazione)** ha iniziato a supportare più [](https://docs.microsoft.com/windows/mixed-reality/release-notes-april-2018) utenti Azure AD nel Aggiornamento di Windows 10 (aprile 2018) come parte [di Windows Holographic for Business](hololens-upgrade-enterprise.md).
...
Per altre informazioni sulla configurazione dell'infrastruttura di identità ibrida, vedere la [documentazione relativa all'identità ibrida di Azure.](https://docs.microsoft.com/azure/active-directory/hybrid/)
