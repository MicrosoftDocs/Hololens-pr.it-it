...
Per impostazione predefinita, come per altri Windows 10, sarà necessario accedere di nuovo quando HoloLens riavvio o ripresa dalla modalità standby. È possibile usare l Impostazioni app per modificare questo comportamento oppure il comportamento può essere controllato da Criteri di gruppo.
...
>[!IMPORTANT]
> Il primo utente del dispositivo è considerato il proprietario del dispositivo, tranne nel caso di Azure AD join, per altre informazioni sui [proprietari del dispositivo.](security-adminless-os.md#device-owner)
...
Per altre informazioni sulla protezione delle identità utente e sull'autenticazione, vedere la [documentazione Windows 10 sicurezza e identità.](/windows/security/identity-protection/)
