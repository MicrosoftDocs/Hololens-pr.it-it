...
4. Connessione il dispositivo nel PC host e aprire Gestione dispositivi. Ad esempio Windows 10 premere il **Windows** e quindi **il tasto X** e quindi selezionare Gestione **dispositivi.** Assicurarsi che il dispositivo enumi correttamente Microsoft HoloLens come illustrato nell'immagine seguente:
...
1. Se il dispositivo non viene visualizzato come dispositivo di HoloLens/HoloLens in Driver bus seriali universali, controllare:
    ...
    1. **Altri dispositivi**, come dispositivo QUSB_BULK: nel PC host mancano i driver necessari per rilevare il HoloLens. Fare clic con il pulsante destro del mouse e selezionare Update Driver (Aggiorna driver) e cercare i driver online o selezionare Optional Updates (Aggiornamenti facoltativi) Windows [Update settings (Aggiorna impostazioni).](https://techcommunity.microsoft.com/t5/windows-it-pro-blog/improving-the-update-discoverability-experience/ba-p/1585674) Dopo aver scaricato il driver, ARC dovrebbe essere in grado di rilevarlo.
