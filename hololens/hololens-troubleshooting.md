...
Nelle build precedenti di Windows Holographic, quando si tenta di scaricare un file bloccato, il risultato sarebbe una pagina di errore HTTP. Nell'Windows Holographic, versione 21H1, il tentativo di scaricare un file bloccato non comporta alcun risultato visibile: il file non viene scaricato e non si verifica alcun errore.
