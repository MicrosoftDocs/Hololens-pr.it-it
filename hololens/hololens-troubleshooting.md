...
Un HoloLens 2 può essere configurato per l'accesso automatico tramite Impostazioni Account Opzioni di accesso   ->    ->    -> e in Richiesto impostare il valore su **Mai**. Ad alcuni utenti potrebbe essere richiesto di accedere di nuovo al dispositivo quando si aggiorna un dispositivo con un aggiornamento di grandi dimensioni, ad esempio un aggiornamento delle funzionalità. Si tratta di **un problema noto.**
...
Si tratta di un problema che interessa gli utenti che si trovavano in una build insider preview, ha ricompresso il proprio HoloLens 2 con una nuova build insider preview e quindi ne ha annullata la registrazione dal programma Insider. Si tratta di un **problema noto.**
...
- Dopo aver abilitato la modalità sviluppatore Impostazioni, potrebbero essere trascorsi alcuni secondi prima che l'interruttore accerti Portale di dispositivi è abilitato.
...
- Assicurarsi che la Wi-Fi sia attivata. Per verificare, usare il movimento Start e quindi selezionare **Impostazioni**  >  **Rete &amp; Internet**  >  **Wi-Fi**. Se Wi-Fi è attivata, provare a disattivarla e quindi attivarla di nuovo.
