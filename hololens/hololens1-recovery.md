...
> [!NOTE]
> Se WDRT non rileva l'HoloLens, provare a riavviare il PC. Se il problema non funziona, selezionare **Il dispositivo non** è stato rilevato, selezionare **Microsoft HoloLens** e quindi seguire le istruzioni.
...
È possibile installare un nuovo sistema operativo nel HoloLens (prima generazione) usando lo Windows di ripristino dei dispositivi. Prima di usare questo strumento, verificare se il riavvio o la reimpostazione del HoloLens risolve il problema.
