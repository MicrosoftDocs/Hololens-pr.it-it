...
1. [Nell Microsoft Endpoint Manager di amministrazione](https://endpoint.microsoft.com)selezionare Dispositivi Windows Windows registrazione e quindi selezionare Devices Import (Importa dispositivi)  >    >  in Windows Autopilot Deployment Program   >   ( Programma di **registrazione dispositivi).**
