...
Si è pronti per esplorare il mondo degli ologrammi?

Questa guida fornisce un'introduzione a:

- Interazione con la realtà mista
- Uso delle mani e della voce per interagire con gli ologrammi HoloLens 2
- Navigazione Windows 10 in HoloLens (Windows olografico)

## <a name="discover-mixed-reality"></a>Scoprire la realtà mista

In HoloLens, gli ologrammi combinano il mondo digitale con l'ambiente fisico per sembrare parte del mondo. Anche quando gli ologrammi sono tutti intorno a te, puoi sempre vedere l'ambiente circostante, spostarti liberamente e interagire con persone e oggetti. Questa esperienza viene chiamata "realtà mista".

La cornice olografica posiziona gli ologrammi dove gli occhi sono più sensibili ai dettagli e le lenti see-through lasciano chiara la visione periferica. Con l'audio spaziale, è possibile individuare un ologramma in ascolto, anche se è dietro l'utente. Inoltre, poiché HoloLens l'ambiente fisico, è possibile posizionare ologrammi su e intorno a oggetti reali, ad esempio tabelle e pareti.

Spostarsi tra HoloLens è molto simile all'uso dello smartphone. È possibile usare le mani per toccare e modificare finestre olografiche, menu e pulsanti.  

Una volta che si conoscono queste interazioni di base, HoloLens sarà un'introduzione.

> [!TIP]
> Se si ha un HoloLens nelle vicinanze, l'app **Suggerimenti** offre esercitazioni di base letterali per le interazioni con la mano HoloLens.  
> Usare il movimento di avvio per passare a **Start** o pronunciare "Vai a Start" e selezionare **Suggerimenti**.

## <a name="the-hand-tracking-frame"></a>Frame di tracciamento della mano

HoloLens ha sensori in grado di vedere qualche metro su entrambi i lati. Quando si usano le mani, è necessario mantenerle all'interno del fotogramma o HoloLens non le vedono. Tuttavia, il frame si sposta con l'utente mentre ci si sposta.  
...
Quando si avvicina un ologramma, avvicinare la mano e sulla punta dell'indice dovrebbe essere visualizzato un anello bianco.  Si tratta del **cursore tocco** che consente di toccare e interagire con gli ologrammi con precisione. Per **selezionare un** elemento, è sufficiente **toccarlo** con il cursore tocco. **Scorrere** il contenuto **scorrendo la** superficie del contenuto con il dito, proprio come si usa un touchscreen.

Per **afferrare** un ologramma nelle vicinanze, avvicinare il **pollice** e il dito **indice** sull'ologramma e tenere premuto. Per lasciar andare, rilasciare le dita. Usa questo **movimento di cattura** per spostare, ridimensionare e ruotare oggetti 3D e finestre dell'app in ambiente iniziale.

Per visualizzare un **menu** di scelta rapida, come quelli che si trovano in un riquadro dell'app nel **menu Start,** toccare e tenere premuto come per un touchscreen.
...
Quando non sono presenti ologrammi accanto alle mani,  il **cursore** tocco si nasconde automaticamente e i raggi della mano vengono visualizzati dal palmo delle mani. I raggi della mano consentono di interagire con gli ologrammi a distanza.

> [!TIP]
> Se si trovano raggi della mano che distraggono, è possibile nasconderli pronunciando "Nascondi raggi mano". Per fare in modo che ricomparti, pronunciare "Show hand rays" (Mostra raggi mano).

### <a name="select-using-air-tap"></a>Selezionare tramite tocco

Per selezionare un elemento **usando il raggio della** mano, seguire questa procedura:

1. Usare un raggio della mano dal palmo per impostare come destinazione l'elemento. Non è necessario alzare l'intero arm, ma è possibile mantenere basso e a proprio agio il lettore.
1. Puntare il dito indice verso l'alto verso il controsoffitto.
1. Per eseguire il movimento **del tocco,** avvicinare le dita del pollice e dell'indice e rilasciarle rapidamente.

   ![Animazione del movimento di tocco](./images/hololens-air-tap.gif)

### <a name="grab-using-air-tap-and-hold"></a>Afferrare con il tocco e tenere premuto
...
Usare **il tocco e tenere premuto** per eseguire le azioni seguenti con il raggio della mano:

- **Scorrere**. Per scorrere il contenuto della finestra dell'app, tocca e tieni premuto il contenuto e quindi sposta il raggio della mano verso l'alto e verso il basso o da un lato all'altro.
- **Afferrare**. Per afferrare una finestra o un ologramma dell'app, imposta come destinazione la barra del titolo o l'ologramma dell'app con il raggio della mano e quindi tieni premuto.
- **Aprire i menu di scelta rapida**. Per aprire i menu di scelta rapida, premere e tenere premuto il raggio della mano.

## <a name="start-gesture"></a>Movimento di avvio

> [!VIDEO https://www.microsoft.com/videoplayer/embed/RE3Wxng]

Il movimento Start apre il **menu Start**.  Per eseguire il movimento Start, tieni la mano con il palmo rivolto verso di te. Verrà visualizzata **un'icona Start sopra** il menu interno. Toccare questa icona usando l'altra mano.  Il menu Start si **aprirà nel punto in cui si sta cercando**.

> [!TIP]
>
> - È possibile usare il movimento Start purché le mani siano all'interno del fotogramma di tracciamento della mano.  Non è necessario guardare l'icona Start. Mantenere i livelli bassi e confortevoli e osservare la direzione in cui si vuole menu Start aprire il dispositivo.
...
> - Se la mano è leggermente fuori dal lato del frame, è comunque possibile visualizzare il menu Start toccando il tocco interno, anche se l'icona non viene visualizzata.
...
> 1. Gli occhi devono essere calibrati sul dispositivo in modo che il tracciamento oculare funzioni correttamente. Se non vengono visualizzati punti in orbiting intorno all'icona Start quando la si osserva, gli occhi non vengono [calibrati](/hololens/hololens-calibration#calibrating-your-hololens-2) sul dispositivo.

È anche possibile eseguire il movimento Start con una sola mano. A tale scopo, tieni la mano con il palmo rivolto verso di te e osserva **l'icona Start** sul tuo sguardo interno. **Tenendo d'occhio l'icona**, avvicinare il pollice e il dito indice.
...
Pronto a mettere alla prova tutte queste interazioni con le mani?
...
Così come Windows PC inizia sempre la propria esperienza sul desktop, HoloLens sempre **in** ambiente iniziale quando è acceso.  Usando il menu Start, è possibile aprire e posizionare le finestre dell'app, nonché le utilità di avvio delle app e il contenuto 3D in ambiente iniziale. I relativi posizionamenti nello spazio fisico verranno memorizzati HoloLens.

Aprire il **menu Start** e quindi selezionare il riquadro **Impostazioni'app.** Verrà visualizzata una finestra dell'app.

Impostazioni è un esempio di un'app HoloLens che usa una finestra **dell'app** 2D.  È molto simile a un'applicazione Windows nel PC.

A questo punto è possibile aprire **menu Start** e selezionare il **riquadro dell Suggerimenti app.** Verrà visualizzata un'utilità di avvio di **app** 3D per l'app. Per aprire l'app, è necessario selezionare il pulsante **di riproduzione** nell'utilità di avvio.

Suggerimenti è un esempio di app **immersive.** Un'app immersiva consente di ambiente iniziale quando viene eseguita e diventa l'unica app visualizzata.  Per uscire, è necessario visualizzare il menu Start e selezionare il **pulsante ambiente iniziale** nella parte inferiore.
...
[Vedere qui per altre informazioni su](holographic-home.md) menu Start e ambiente iniziale, incluse informazioni su come usare e gestire le app HoloLens 2.
