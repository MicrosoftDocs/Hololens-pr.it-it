...
- **Pulsante di alimentazione**. Quando si indossa HoloLens, il pulsante di accensione si trova sul lato destro del coperchio esterno posteriore.
...
| **Power draw** | Per mantenere o far avanzare la percentuale di carica della batteria interna mentre il dispositivo è in funzione, è necessario collegarlo almeno a un caricabatterie da 15W. |
...
| **Guide di Dynamics 365** |  [Dynamics 365 Guides](https://www.microsoft.com/p/microsoft-dynamics-365-guides/9n038fb42kkb?activetab=pivot:overviewtab) i dipendenti apprendono più rapidamente le nuove competenze nei HoloLens mobili. |
...
| **Esplora file** | Esplora file un'interfaccia utente grafica per l'accesso ai file system. |
...
| **OneDrive** | [OneDrive](https://www.microsoft.com/p/onedrive/9wzdncrfj1p3?activetab=pivot:overviewtab) consente di accedere e modificare i file da tutti i dispositivi in qualsiasi posizione.  |
...
|     Profondità del corriere esterno     |     172,01 mm          |     6,772 pollici        |
