...
- **Visore**. Contiene i HoloLens e le schermi. È possibile ruotare il visore verso l'alto mentre si ruota il HoloLens.
...
- **Pulsanti luminosità**. Quando si indossano le HoloLens, i pulsanti di luminosità si trova sul lato sinistro del visore vicino al tempio.
...
- **[Caricatore USB-C e cavo](https://www.microsoft.com/p/microsoft-hololens-2-usb-c-charger-cable/8vj21f2z8pk5)**. L'alimentatore si collega alla presa di alimentazione. Usare il cavo USB-C per collegare il HoloLens all'alimentatore per la ricarica o per collegare il HoloLens al computer.
...
| &nbsp; | &nbsp; |
|---|---|
| **Windows Sistema operativo olografico** | Con Windows sistema operativo [Holographic,](hololens-release-notes.md)Windows 10 gli utenti potranno usare alcune app e giochi in un ambiente di realtà mista tramite il HoloLens 2.
...
| **Impostazioni** | L Impostazioni app è la posizione in cui è possibile personalizzare in dettaglio Windows'app Holographic.  |
