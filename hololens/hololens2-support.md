...
author: raunakjhawar
ms.reviewer: asergaz
description: Opzioni di supporto per realtà mista per clienti aziendali di piccole e grandi dimensioni
ms.prod: hololens
ms.topic: article
ms.date: 3/19/2021
...
Per risposte rapide e affidabili alle domande sulla programmazione di Realtà mista di Azure e HoloLens 2 da tecnici Microsoft, MVP (Most Valuable Professionals) o dalla community di esperti, è possibile partecipare a Microsoft Q&A, la destinazione preferita di Microsoft per il supporto della community.
...
- Creare una richiesta di supporto per la HoloLens 2 visore VR immersive al supporto [mr](https://aka.ms/mrsupport) 
- Creare una richiesta di supporto per problemi HoloLens 2 dispositivi, tra cui hardware, & configurazione del dispositivo HoloLens 2 [dispositivo](https://aka.ms/hlsupport) 
...
- Per assistenza tramite supporto telefonico, vedere l'elenco seguente di numeri di telefono dell'ufficio per parlare con i colleghi del supporto commerciale
- Per gli acquisti al di fuori Microsoft Store, fare riferimento a questo elenco di rivenditori [HoloLens 2](hololens2-purchase.md) autorizzati e paesi in HoloLens 2 disponibili.
...
| Australia |   1800-217-709 |  Da lun a ven, dalle 8:00 alle 20:00 |
| Singapore |   1800 622-1816 | Da lun a ven, dalle 8:30 alle 17:30 |
| Nuova Zelanda | 0800 471 640 |  Da lun a ven, dalle 8:00 alle 18:00 |

>[!IMPORTANT]
>Se è necessaria una fattura completa per l'IVA, è necessario entrare direttamente in contatto con il team di Commercial Support Store e non acquistare un dispositivo online. Tutti gli acquisti effettuati online riceveranno solo una fattura con IVA semplificata che non può essere modificata in un secondo momento.
...
Per aprire un ticket di supporto tecnico nel portale di Azure per Ancoraggi nello Ancoraggi di oggetti di Azure Azure o Rendering remoto di Azure:

1. Con il [portale di Azure](https://azure.microsoft.com/account/) aperto, selezionare l'icona della Guida nella barra dei menu superiore e quindi selezionare il pulsante **Guida e** supporto.
...
### <a name="provide-documentation-content-feedback"></a>Fornire commenti e suggerimenti sul contenuto della documentazione

Nella parte inferiore di ogni articolo sul contenuto è possibile aprire un problema di GitHub e inviare commenti e suggerimenti sul contenuto in qualsiasi repository di documentazione di realtà mista. 

### <a name="provide-product-feedback"></a>Inviare commenti e suggerimenti per il prodotto

>[!Note]
>Fornire commenti e suggerimenti è un ottimo modo per fare in modo che la voce senta, ma il feedback non è un modo per ricevere una risposta. Hub di Feedback possono essere combinate con altre opzioni di supporto.
...
- [HoloLens 2 Commenti e suggerimenti sul prodotto](/hololens/hololens-feedback)
- [Commenti e suggerimenti sul prodotto dell'app Microsoft Mesh](/hololens/hololens-feedback)
- [Rendering remoto di Azure feedback](https://feedback.azure.com/forums/928696-azure-remote-rendering)
- [Commenti e suggerimenti su Ancoraggi nello stato di Azure](https://feedback.azure.com/forums/919252-azure-spatial-anchors)
...
- Ancoraggi nello stato di Azure, vedere la [pagina delle domande](/azure/spatial-anchors/spatial-anchor-faq) frequenti
