...
description: Come eseguire l'indirizzo MAC per la rete HoloLens 2 dispositivi
ms.prod: hololens
ms.sitesec: library
author: evmill
ms.author: mata
...
2. Senza l'indirizzo MAC, il dispositivo non può partecipare alla Wi-Fi per iniziare la registrazione.
...
> [!NOTE] 
> Se anche la rete cablata è soggetta a restrizioni MAC, l'indirizzo MAC dell'adattatore USB-C Hub + Ethernet dovrà essere pre-approvato. È necessario fare attenzione con questa scheda perché consentirà l'accesso alla rete da altri dispositivi.
...
1. Creare la HoloLens criteri di Intune.
